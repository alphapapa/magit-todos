...
Activate =magit-todos-follow-mode= in =magit-todos-mode=, use
@@html:<kbd>@@n@@html:</kbd>@@, @@html:<kbd>@@C-n@@html:</kbd>@@,
@@html:<kbd>@@<down>@@html:</kbd>@@ to follow the file of the next todo item and use
