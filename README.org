...
*Added*
+  Branch diff task list.  See new option =magit-todos-show-branch-list=, and command =magit-todos-toggle-branch-list=, bound to =b= with point on to-do list heading.  ([[https://github.com/alphapapa/magit-todos/issues/77][#77]].  Thanks to [[https://github.com/arronmabrey][Arron Mabrey]] for the suggestion.)
